    ...
    <Wrapper>
      <RowBetween>
        ...
        <AutoRow $gap="6px" style={{ justifyContent: 'flex-end' }}>
          ...
          <StyledLink href="https://gliquids-organization.gitbook.io/gliquid">Docs</StyledLink>
          <StyledLink href="https://www.gliquid.xyz/swap">App</StyledLink>
        </AutoRow>
      </RowBetween>
    </Wrapper>
  )
